...
## Waybar (not used here)

```jsonc
"custom/mouse-battery": {
    "exec": "/home/samurai/glorious-model-o2-pro-battery/glorious-battery.py --waybar",
    "return-type": "json",
    "interval": 60,
    "tooltip": true
}
...
| `install.sh` | Copy the plugin and reader into `~/.local/share/noctalia-bar/noctalia/plugins/`. |
| `README.md` | This note. |
